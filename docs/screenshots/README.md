...
Images in this folder are the **product gallery**. All **required pack** shots are captured (SPK-1700d landed). Preview is a filled 2.5D heightfield, not a GPU mill sim.
...
| `06-preview.png` | Preview | Sheet + **filled heightfield** (post-1700a) — wireframe + heightfield sim. |

## Required pack (all captured — SPK-1700d landed)

| File | Composition (must match) |
| --- | --- |
| `welcome.png` | First-run / **Start Making** Welcome: bundled **samples** (sign, box, keychain, plaque). Stage rail or Welcome chrome; no laser CTA. |
