...
- `HeightfieldFinishEngine` drives **XY of the ball center along the heightfield
  ...
  the incumbent's documented finish stepover is **8–12% of D**.
...
Fusion: photoreal wins mockups; operators bounce to the incumbent for signs because
...
### 3D relief (the incumbent suite + Fusion split the market)

**the incumbent suite 3D Rough** (vendor help docs):
...
**the incumbent suite 3D Finish** (vendor help docs):
...
Fusion Adaptive 3D · steep/shallow split · pencil/collapsed pencil · the incumbent suite
