...
- [ ] **SPK-0801** **PLAT** Double-sided job + multi-sided view 
  ...
  - deps: SPK-0800  
- [ ] **SPK-0802** **TP** Inlay pocket/plug + VCarve inlay recipes — **pocket/plug shipped 2026-08-05 (lean slice, reuses VCarve flat-bottom + Profile on-cut); VCarve inlay recipe presets remain** (SPK-0802 worklog)
  - **Backlog (post-v1):** do not start until SPK-0623 `[x]`. AC = real engine+UI+persist+verify per `docs/planning/FINISH_ROADMAP.md` Track 6.
...
- [ ] **SPK-0900** **TP** Fluting, texture, prism, chamfer, moulding — **3 of 5 shipped 2026-08-05 (fluting/prism/chamfer, lean slices); texture + moulding remain** (SPK-0900 worklog)
...
- [ ] **SPK-0906** **TP** Laser cut/fill/picture (per PACKAGING) 
  ...
  - deps: SPK-0903
- [ ] **SPK-0907** **TP** Gadgets: keyhole, rounding, drag knife — **keyhole shipped 2026-08-05 (Design "Keyhole…" gadget); rounding covered by Fillet/Chamfer; drag knife remains** (SPK-0907 worklog)
  - **Backlog (post-v1):** do not start until SPK-0623 `[x]`. AC = real engine+UI+persist+verify per `docs/planning/FINISH_ROADMAP.md` Track 6.
