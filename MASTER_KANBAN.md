...
- [ ] **SPK-1900** **PROD** PC-parity parent — Photo stage + lithophane; Frame + click-to-jog; Beginner/Advanced + starters; machine-dock-everywhere audit; Image-to-Relief; nesting; open-source docs. Deps: none. DoD on parent.
