...
- [ ] **SPK-1403** **PLAT** AppSession split parent — sample-load extracted (1403a); remaining slices 1403b–d `[x]` + facade/bindings intact. Deps: none. DoD on parent (all slices `[x]` + no behavior change).
